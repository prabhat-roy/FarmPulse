...
spark = SparkSession.builder.appName("farmpulse-aggregate-daily").getOrCreate()
df = spark.read.format("iceberg").load("farmpulse_mart.events_raw")
...
result.writeTo("farmpulse_mart.fct_daily_metrics").using("iceberg").overwritePartitions()
