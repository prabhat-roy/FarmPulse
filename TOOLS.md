# TOOLS.md — every OSS tool registered for FarmPulse

This file is the single inventory of every OSS tool wired up for FarmPulse.
...
| messaging | [thethingsnetwork](messaging/thethingsnetwork/) | `messaging/thethingsnetwork/` (scaffold) |
...
| domain-oss | [aggateway-adapt](domain-oss/aggateway-adapt/) | `domain-oss/aggateway-adapt/` (deployable) |
| domain-oss | [openfarm](domain-oss/openfarm/) | `domain-oss/openfarm/` (deployable) |
| domain-oss | [plantnet](domain-oss/plantnet/) | `domain-oss/plantnet/` (deployable) |
